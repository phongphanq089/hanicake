    ...
    return (
        <Box component="form" noValidate ref={ formRef }>
            <Stack direction="column" alignItems="start" mb={ 2 }>
                <Typography variant="title2">Dining</Typography>
                <Typography variant="blog-date">you will eat cake at the shop</Typography>
            </Stack>
